...
do
	...
	cztgtigen $evtsep_single mkffile=$mkffile outfile=$gtievt $mkfthresh usergtifile=-
	...
	do
		...
		#cztbindata inevtfile=$cleanevt mkffile=$mkffile  badpixfile=$flickbadpixfile livetimefile=$superbunchlivetime outfile=$bindataout outevtfile=$wtevt maskWeight="yes" rasrc="40.91806" decsrc="61.43412" badpixThreshold=0 outputtype="both" timebinsize="1" energyrange=$i clobber="y"
